...
```{r, echo=TRUE}
data_rongji  <- read_excel("ScreenTime_rongji.xlsx") 
data_yangme  <- read_excel("ScreenTime_yangme.xlsx") 
data_zyzahng <- read_excel("ScreenTime_zyzahng.xlsx") 
```
...
oracle_model <- lm(Total.ST.min~ Pickups + Pickup.1st.angular + temp, data = data_merge)
